<?php
//Instance de PDO utilisée pour l'insertion d'une personne et également pour la récupération de la liste des professions
$pdo = getPDO();
...
if($isPosted){
        ...
        //Si id null alors on insère la nouvelle profession
        //Puis on récupère l'id généré pour l'affecter $person["profession]
        if($result === false){
