...
//Les donnée ne sont pas postées et l'id n'est pas nul
//Il faut alors récuperer les infos de la personne depuis la BD
...
if($id >0 && ! $isposted){
    try {
        ...
        $pageTitle = "Erreur";
        $errorMessage ="Une erreur empêche la la lecture de infos d'une peronne sur la base de donnée";
...
//Traitement du formaulraire si les données sont postées
if($isposted){
    ...
    try{
        ...
        $pageTitle = "Erreur";
        $errorMessage ="Une erreur empêche la création d'une personne sur la base de donnée";
        $content ="../views/error.php";
